#ifndef SEARCH_ALGORITHMS_ALTERNATING_WASTAR_FOCAL_RANDOM_H
#define SEARCH_ALGORITHMS_ALTERNATING_WASTAR_FOCAL_RANDOM_H
...
class AlternatingWAStarFocalRandom : public SearchAlgorithm {
    struct Entry {
        StateID state_id;
        int g;
        int h;
    ...
    std::optional<Entry> select_focal_random_entry();
