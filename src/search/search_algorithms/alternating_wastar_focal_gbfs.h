#ifndef SEARCH_ALGORITHMS_ALTERNATING_WASTAR_FOCAL_GBFS_H
#define SEARCH_ALGORITHMS_ALTERNATING_WASTAR_FOCAL_GBFS_H
...
class AlternatingWAStarFocalGBFS : public SearchAlgorithm {
    struct Entry {
        StateID state_id;
        int g;
        int h;
    ...
    std::optional<Entry> select_focal_gbfs_entry();
...
public:
    AlternatingWAStarFocalGBFS(
        const std::shared_ptr<Evaluator> &eval, bool reopen_closed,
        int wastar_weight, double focal_weight, int random_seed,
