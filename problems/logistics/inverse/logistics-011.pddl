(define (problem logistics-ipc-011-inverse)
  (:domain logistics)
  ...
  (:init
    (= (total-cost) 0)
    (= (package-cost obj11) 9)
    (= (package-cost obj12) 8)
    (= (package-cost obj13) 7)
    (= (package-cost obj21) 6)
    (= (package-cost obj22) 5)
    (= (package-cost obj23) 4)
    (= (package-cost obj31) 3)
    (= (package-cost obj32) 2)
  ...
  (:goal
    (and
      ...
      (at-package obj12 pos2)
      (at-package obj13 apt3)
      (at-package obj31 apt2)
      (at-package obj23 apt1)
      (at-package obj32 pos1)
    )
  )
