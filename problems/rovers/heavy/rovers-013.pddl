(define (problem rovers-ipc-013-heavy)
  (:domain rovers)
  ...
  (:init
    ...
    (= (sample-cost waypoint6) 10)
    (= (sample-cost waypoint7) 10)
    (= (sample-cost waypoint8) 10)
    (= (image-cost objective0) 1)
    (= (image-cost objective1) 1)
    (= (image-cost objective2) 1)
    (= (image-cost objective3) 10)
    (= (rover-cost rover0) 1)
    (= (rover-cost rover1) 1)
    (= (rover-cost rover2) 1)
    (= (rover-cost rover3) 10)
    (= (communicate-cost) 1)
