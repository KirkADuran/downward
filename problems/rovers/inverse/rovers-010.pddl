(define (problem rovers-ipc-010-inverse)
  (:domain rovers)
  ...
  (:init
    (= (total-cost) 0)
    (= (sample-cost waypoint0) 7)
    (= (sample-cost waypoint1) 6)
    (= (sample-cost waypoint2) 5)
    (= (sample-cost waypoint3) 4)
    (= (sample-cost waypoint4) 3)
    (= (sample-cost waypoint5) 2)
