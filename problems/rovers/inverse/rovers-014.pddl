(define (problem rovers-ipc-014-inverse)
  (:domain rovers)
  ...
  (:init
    (= (total-cost) 0)
    (= (sample-cost waypoint0) 10)
    (= (sample-cost waypoint1) 9)
    (= (sample-cost waypoint2) 8)
    (= (sample-cost waypoint3) 7)
    (= (sample-cost waypoint4) 6)
    (= (sample-cost waypoint5) 5)
    (= (sample-cost waypoint6) 4)
    (= (sample-cost waypoint7) 3)
    (= (sample-cost waypoint8) 2)
