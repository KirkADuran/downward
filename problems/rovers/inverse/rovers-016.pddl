(define (problem rovers-ipc-016-inverse)
  (:domain rovers)
  ...
  (:init
    (= (total-cost) 0)
    (= (sample-cost waypoint0) 12)
    (= (sample-cost waypoint1) 11)
    (= (sample-cost waypoint2) 10)
    (= (sample-cost waypoint3) 9)
    (= (sample-cost waypoint4) 8)
    (= (sample-cost waypoint5) 7)
    (= (sample-cost waypoint6) 6)
    (= (sample-cost waypoint7) 5)
    (= (sample-cost waypoint8) 4)
    (= (sample-cost waypoint9) 3)
    (= (sample-cost waypoint10) 2)
