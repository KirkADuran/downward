(define (problem rovers-ipc-013-inverse)
  (:domain rovers)
  ...
  (:init
    (= (total-cost) 0)
    (= (sample-cost waypoint0) 9)
    (= (sample-cost waypoint1) 8)
    (= (sample-cost waypoint2) 7)
    (= (sample-cost waypoint3) 6)
    (= (sample-cost waypoint4) 5)
    (= (sample-cost waypoint5) 4)
    (= (sample-cost waypoint6) 3)
    (= (sample-cost waypoint7) 2)
