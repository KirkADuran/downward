(define (problem rovers-ipc-015-inverse)
  (:domain rovers)
  ...
  (:init
    (= (total-cost) 0)
    (= (sample-cost waypoint0) 11)
    (= (sample-cost waypoint1) 10)
    (= (sample-cost waypoint2) 9)
    (= (sample-cost waypoint3) 8)
    (= (sample-cost waypoint4) 7)
    (= (sample-cost waypoint5) 6)
    (= (sample-cost waypoint6) 5)
    (= (sample-cost waypoint7) 4)
    (= (sample-cost waypoint8) 3)
    (= (sample-cost waypoint9) 2)
    (= (sample-cost waypoint10) 1)
    (= (image-cost objective0) 5)
    (= (image-cost objective1) 4)
    (= (image-cost objective2) 3)
    (= (image-cost objective3) 2)
