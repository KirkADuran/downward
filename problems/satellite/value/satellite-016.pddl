(define (problem satellite-ipc-016-value)
  (:domain satellite)
  ...
  (:init
    ...
    (= (target-cost phenomenon9) 5)
    (= (target-cost phenomenon17) 6)
    (= (target-cost phenomenon18) 7)
    (= (target-cost phenomenon23) 8)
    (= (target-cost planet6) 9)
    (= (target-cost planet7) 10)
    (= (target-cost planet8) 11)
    (= (target-cost planet10) 12)
    (= (target-cost planet11) 13)
    (= (target-cost planet19) 14)
    (= (target-cost planet21) 15)
    (= (target-cost planet22) 16)
    (= (target-cost star2) 17)
    (= (target-cost star3) 18)
    (= (target-cost star12) 19)
    (= (target-cost star13) 20)
    (= (target-cost star14) 21)
    (= (target-cost star15) 22)
    (= (target-cost star16) 23)
    (= (target-cost star20) 24)
