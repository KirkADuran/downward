(define (problem satellite-ipc-016-inverse)
  (:domain satellite)
  ...
  (:init
    ...
    (= (target-cost phenomenon5) 22)
    (= (target-cost phenomenon9) 21)
    (= (target-cost phenomenon17) 20)
    (= (target-cost phenomenon18) 19)
    (= (target-cost phenomenon23) 18)
    (= (target-cost planet6) 17)
    (= (target-cost planet7) 16)
    (= (target-cost planet8) 15)
    (= (target-cost planet10) 14)
    (= (target-cost planet11) 13)
    (= (target-cost planet19) 12)
    (= (target-cost planet21) 11)
    (= (target-cost planet22) 10)
    (= (target-cost star2) 9)
    (= (target-cost star3) 8)
    (= (target-cost star12) 7)
    (= (target-cost star13) 6)
    (= (target-cost star14) 5)
    (= (target-cost star15) 4)
    (= (target-cost star16) 3)
    (= (target-cost star20) 2)
    (= (target-cost star24) 1)
    (= (instrument-cost instrument0) 23)
    (= (instrument-cost instrument1) 22)
    (= (instrument-cost instrument2) 21)
    (= (instrument-cost instrument3) 20)
    (= (instrument-cost instrument4) 19)
    (= (instrument-cost instrument5) 18)
    (= (instrument-cost instrument6) 17)
    (= (instrument-cost instrument7) 16)
    (= (instrument-cost instrument8) 15)
    (= (instrument-cost instrument9) 14)
    (= (instrument-cost instrument10) 13)
    (= (instrument-cost instrument11) 12)
    (= (instrument-cost instrument12) 11)
    (= (instrument-cost instrument13) 10)
    (= (instrument-cost instrument14) 9)
    (= (instrument-cost instrument15) 8)
    (= (instrument-cost instrument16) 7)
    (= (instrument-cost instrument17) 6)
    (= (instrument-cost instrument18) 5)
    (= (instrument-cost instrument19) 4)
    (= (instrument-cost instrument20) 3)
    (= (instrument-cost instrument21) 2)
    (= (instrument-cost instrument22) 1)
    (= (satellite-move-cost satellite0) 10)
    (= (satellite-move-cost satellite1) 9)
    (= (satellite-move-cost satellite2) 8)
    (= (satellite-move-cost satellite3) 7)
    (= (satellite-move-cost satellite4) 6)
    (= (satellite-move-cost satellite5) 5)
    (= (satellite-move-cost satellite6) 4)
    (= (satellite-move-cost satellite7) 3)
    (= (satellite-move-cost satellite8) 2)
