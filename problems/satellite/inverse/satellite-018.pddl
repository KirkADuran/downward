(define (problem satellite-ipc-018-inverse)
  (:domain satellite)
  ...
  (:init
    (= (total-cost) 0)
    (= (target-cost groundstation2) 25)
    (= (target-cost phenomenon5) 24)
    (= (target-cost phenomenon12) 23)
    (= (target-cost phenomenon13) 22)
    (= (target-cost phenomenon16) 21)
    ...
    (= (target-cost planet7) 15)
    (= (target-cost planet11) 14)
    (= (target-cost planet14) 13)
    (= (target-cost planet19) 12)
    (= (target-cost planet20) 11)
    (= (target-cost planet23) 10)
    (= (target-cost star0) 9)
    (= (target-cost star1) 8)
    (= (target-cost star3) 7)
    (= (target-cost star4) 6)
    (= (target-cost star8) 5)
    (= (target-cost star9) 4)
    (= (target-cost star10) 3)
    (= (target-cost star15) 2)
    (= (target-cost star22) 1)
    (= (instrument-cost instrument0) 13)
    (= (instrument-cost instrument1) 12)
    (= (instrument-cost instrument2) 11)
    (= (instrument-cost instrument3) 10)
    (= (instrument-cost instrument4) 9)
    (= (instrument-cost instrument5) 8)
    (= (instrument-cost instrument6) 7)
    (= (instrument-cost instrument7) 6)
    (= (instrument-cost instrument8) 5)
    (= (instrument-cost instrument9) 4)
    (= (instrument-cost instrument10) 3)
    (= (instrument-cost instrument11) 2)
