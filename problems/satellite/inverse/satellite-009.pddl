(define (problem satellite-ipc-009-inverse)
  (:domain satellite)
  ...
  (:init
    ...
    (= (target-cost phenomenon6) 14)
    (= (target-cost phenomenon7) 13)
    (= (target-cost phenomenon8) 12)
    (= (target-cost phenomenon12) 11)
    (= (target-cost phenomenon13) 10)
    (= (target-cost planet5) 9)
    (= (target-cost planet10) 8)
    (= (target-cost planet11) 7)
    (= (target-cost star0) 6)
    (= (target-cost star2) 5)
    (= (target-cost star3) 4)
    (= (target-cost star4) 3)
