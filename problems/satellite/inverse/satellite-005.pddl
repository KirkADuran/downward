(define (problem satellite-ipc-005-inverse)
  (:domain satellite)
  ...
  (:init
    (= (total-cost) 0)
    (= (target-cost groundstation0) 10)
    (= (target-cost groundstation1) 9)
    (= (target-cost groundstation2) 8)
    (= (target-cost phenomenon5) 7)
    (= (target-cost phenomenon6) 6)
    (= (target-cost phenomenon8) 5)
    (= (target-cost planet9) 4)
    (= (target-cost star3) 3)
    (= (target-cost star4) 2)
    (= (target-cost star7) 1)
