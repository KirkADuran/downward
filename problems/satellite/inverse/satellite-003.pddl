(define (problem satellite-ipc-003-inverse)
  (:domain satellite)
  ...
  (:init
    (= (total-cost) 0)
    (= (target-cost phenomenon5) 8)
    (= (target-cost phenomenon6) 7)
    (= (target-cost phenomenon7) 6)
    (= (target-cost star0) 5)
    (= (target-cost star1) 4)
    (= (target-cost star2) 3)
    (= (target-cost star3) 2)
    (= (target-cost star4) 1)
    (= (instrument-cost instrument0) 4)
    (= (instrument-cost instrument1) 3)
    (= (instrument-cost instrument2) 2)
    (= (instrument-cost instrument3) 1)
    (= (satellite-move-cost satellite0) 2)
