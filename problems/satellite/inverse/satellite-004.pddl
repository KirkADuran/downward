(define (problem satellite-ipc-004-inverse)
  (:domain satellite)
  ...
  (:init
    (= (total-cost) 0)
    (= (target-cost groundstation1) 10)
    (= (target-cost phenomenon8) 9)
    (= (target-cost phenomenon9) 8)
    (= (target-cost planet3) 7)
    (= (target-cost planet5) 6)
    (= (target-cost star0) 5)
    (= (target-cost star2) 4)
    (= (target-cost star4) 3)
    (= (target-cost star6) 2)
    (= (target-cost star7) 1)
    (= (instrument-cost instrument0) 3)
